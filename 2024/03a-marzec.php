<section id="marzec-<?php echo $rok_kal?>">
    <article class="lewa wzor_B">
        <div class="tresc">
    <?php             
        for ($dzien = 0 ; $dzien < $_03a_ilosc_d; $dzien++){
            echo '<div class="dzien ' . ($tydzien[$_03a_nazwa_d]) . ' d_roku_' . $_03a_nr_dnia_roku . '">'
                . '<div class="nr_dnia"><p>' . ($_03a_nr_dnia) . '</p></div>'
                . '<div class="nazwad"><p>' . ($tydzien[$_03a_nazwa_d]) . '</p></div>'
                . '<div class="dane">'
                    . '<p class="sigla">' . ($$sigla[$_03a_nr_dnia_roku]) . '</p>';
                    if (!empty($kwiecien[$_03a_nr_dnia])) {
                        echo '<div class="obchod">' . ($kwiecien[$_03a_nr_dnia]) . '</div>';
                    }
            ...
            $_03a_nr_dnia++;
            $_03a_nr_dnia_roku++;
            if ($_03a_nr_dnia == $_03a_przelam + 1) {
                echo '</div>'
                . '</article>'
